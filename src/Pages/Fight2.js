...
const Vs2 = () => {
	...
	const { token_id, rarity } = useParams();
	...
	async function level_1_Battle() {
		try {
			...
			if (result.status === 'success') {
				...
				console.log("tokenIDinAction - tokenId:" + token_id);
				...
				fetchLastBattleResultByToken(token_id);
				...
				{_lastBattleResultByToken ?
					<div class="popup-containerMain3">
						<div class="popup-containerMain">
							<div class="popup">
								<img src={battleImages2[rarity]} alt="Man" class="character--2" />
								<Link to="/battle"> <span class="close-button">&times;</span></Link>
				...
				{_lastBattleResultByToken == false ?
					<div className="popup-containerMain3">
						<div className="popup-containerMain">
							<div className="popup">
								<img src={battleImages2[rarity]} alt="Man" className="character--2" />
								<Link to="/battle"> <span class="close-button">&times;</span></Link>
