      ...
      <div className="navbar-clip bg-[#41305F6B] backdrop-blur-md">
        <nav className="container mx-auto px-[12px] flex h-[72px] justify-between sm:h-[62px] md:h-[72px] lg:h-[88px] xl:h-[102px] 2xl:h-[115px]">
          ...
          <div className="flex text-[12px] xl:text-[14px] 2xl:text-[16px] xl:gap-[20px] 2xl:gap-[40px] -translate-y-[14px] lg:-translate-y-[18px] xl:-translate-y-[22px] 2xl:-translate-y-[23px] items-center">
            ...
            {_connected ?
              <button onClick={() => disconnectWallet()} className="connect-button bg-gradient-to-r from-[#B014A5] via-[#6514DB] to-[#B014A5] bg-[length:200%_200%] font-vermin-vibes-v text-[10px] xl:text-[11px] 2xl:text-[13px] px-[3.5em] py-[0.8em] transition-all duration-500 hover:bg-right hover:shadow-[0_0_5px_0_#B014A5]">
                {walletAddress === "" ? "CONNECT" : shortenAddress(walletAddress)}
              </button> :
              <button onClick={() => { open(); }} className="connect-button bg-gradient-to-r from-[#B014A5] via-[#6514DB] to-[#B014A5] bg-[length:200%_200%] font-vermin-vibes-v text-[10px] xl:text-[11px] 2xl:text-[13px] px-[3.5em] py-[0.8em] transition-all duration-500 hover:bg-right hover:shadow-[0_0_5px_0_#B014A5]">
                CONNECT
              </button>
            }
            <button
        ...
        <div className="container w-full mx-auto flex justify-end">
          ...
          >
            ...
            {_connected ?
              ...
              <button onClick={() => { open(); }} className="bg-gradient-to-r from-[#B014A5] via-[#6514DB] to-[#B014A5] bg-[length:200%_200%] font-vermin-vibes-v text-[13px] my-[1em] px-[3.5em] py-[0.8em] transition-all duration-500 hover:bg-right hover:shadow-[0_0_5px_0_#B014A5]">
                CONNECT
              </button>}
          </nav>
        </div>
